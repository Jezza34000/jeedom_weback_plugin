       ...
       if ($json['Request_Result'] == 'success') {
         /*event::add('jeedom::alert', array(
           ...
           if (!is_object($robot)) {
             ...
             $mitsubishi->setConfiguration('Thing_Nick_Name', $json['Request_Cotent'][0]['Thing_Nick_Name']);
             $mitsubishi->setConfiguration('Sub_type', $json['Request_Cotent'][0]['Sub_type']);
             $mitsubishi->setConfiguration('Thing_Name', $json['Request_Cotent'][0]['Thing_Name']);//0 air/air, 1 air/water
             $robot->save();
           } else {
